...
\author{Hammond~Pearce,~\IEEEmembership{Member,~IEEE,}
        Xin~Yang,~\IEEEmembership{Fellow,~OSA,}
        and~Partha~Roop,~\IEEEmembership{Life~Fellow,~IEEE}% <-this % stops a space
